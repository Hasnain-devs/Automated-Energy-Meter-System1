<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminWeb.aspx.cs" Inherits="electricity.WebForm2" %>
...
<section class="register">
	<div class="header">
		<div class="logo">
			<a href="#">Electricity Department Administrator</a>
		</div>
	<div class="social">
	...
	<div class="register-full">
		<div class="register-left">
			<div class="register">
				...
				<h1>Hi! Admin</h1>
				<h2></h2>
				<p>Here you have privillages to Add,View,Update,Delete and Find Customers.</p>
				<div class="content3">
					<ul>
		...
		<div class="register-right">
			...
			<div class="register-in">
				<a href="add.aspx" >Add customers »</a>
			</div>
			<div class="register-in middle">
				<a href="find.aspx">Find Customers »</a>
			</div>
			<div class="register-in">
				<a  href="view.aspx">View All customers »</a>
			</div>
